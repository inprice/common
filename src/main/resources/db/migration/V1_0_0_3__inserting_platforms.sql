...
insert into platform (domain, class_name, country, currency_code, currency_format) values
  ('amazon.com', 'xx.AmazonXX', 'United States', 'USD', '$#,##0.00'),
  ('ebay.com', 'xx.EbayXX', 'United States', 'USD', '$#,##0.00'),
  ('apple.com', 'xx.AppleXX', 'United States', 'USD', '$#,##0.00'),
  ('bestbuy.com', 'us.BestBuyUS', 'United States', 'USD', '$#,##0.00'),
  ('bonanza.com', 'us.BonanzaUS', 'United States', 'USD', '$#,##0.00'),
  ('etsy.com', 'us.EtsyUS', 'United States', 'USD', '$#,##0.00'),
  ...
  ('euronics.co.uk', 'uk.EuronicsUK', 'United Kingdom', 'GBP', '£#,##0.00'),
  ('lidl.co.uk', 'xx.LidlXX', 'United Kingdom', 'GBP', '£#,##0.00'),
  ('newlook.com', 'uk.NewLookUK', 'United Kingdom', 'GBP', '£#,##0.00'),
  ('zalando.co.uk', 'xx.ZalandoXX', 'United Kingdom', 'GBP', '£#,##0.00'),
  ('zavvi.com', 'uk.ZavviUK', 'United Kingdom', 'GBP', '£#,##0.00'),

  ('amazon.ca', 'xx.AmazonXX', 'Canada', 'CAD', '$#,##0.00'),
  ('ebay.ca', 'xx.EbayXX', 'Canada', 'CAD', '$#,##0.00'),
  ('apple.com/ca', 'xx.AppleXX', 'Canada', 'CAD', '$#,##0.00'),
  ('bestbuy.ca', 'ca.BestBuyCA', 'Canada', 'CAD', '$#,##0.00'),
  ('canadiantire.ca', 'ca.CanadianTireCA', 'Canada', 'CAD', '$#,##0.00'),

  ('amazon.com.au', 'xx.AmazonXX', 'Australia', 'AUD', '$#,##0.00'),
  ('ebay.com.au', 'xx.EbayXX', 'Australia', 'AUD', '$#,##0.00'),
  ('apple.com/au', 'xx.AppleXX', 'Australia', 'AUD', '$#,##0.00'),
  ('appliancesonline.com.au', 'au.AppliancesOnlineAU', 'Australia', 'AUD', '$#,##0.00'),
  ...
  ('ebay.nl', 'xx.EbayXX', 'Netherlands', 'EUR', '€ #,##0.00'),
  ('apple.com/nl', 'xx.AppleXX', 'Netherlands', 'EUR', '€ #,##0.00'),
  ('bol.com', 'nl.BolNL', 'Netherlands', 'EUR', '€ #,##0.00'),
  ...
  ('zalando.nl', 'xx.ZalandoXX', 'Netherlands', 'EUR', '€ #,##0.00'),

  ('amazon.fr', 'xx.AmazonXX', 'France', 'EUR', '#,##0.00 €'),
  ('ebay.fr', 'xx.EbayXX', 'France', 'EUR', '#,##0.00 €'),
  ...
  ('amazon.it', 'xx.AmazonXX', 'Italy', 'EUR', '€ #,##0.00'),
  ('ebay.it', 'xx.EbayXX', 'Italy', 'EUR', '€ #,##0.00'),
  ('apple.com/it', 'xx.AppleXX', 'Italy', 'EUR', '€ #,##0.00'),
  ('bonprix.it', 'xx.BonprixXX', 'Italy', 'EUR', '€ #,##0.00'),
  ('euronics.it', 'it.EuronicsIT', 'Italy', 'EUR', '€ #,##0.00'),
  ('lidl.it', 'xx.LidlXX', 'Italy', 'EUR', '€ #,##0.00'),
  ('mediaworld.it', 'it.MediaWorldIT', 'Italy', 'EUR', '€ #,##0.00'),
  ('vidaxl.it', 'xx.VidaXLXX', 'Italy', 'EUR', '€ #,##0.00'),
  ('zalando.it', 'xx.ZalandoXX', 'Italy', 'EUR', '€ #,##0.00'),

  ('amazon.es', 'xx.AmazonXX', 'Spain', 'EUR', '€ #,##0.00'),
  ('ebay.es', 'xx.EbayXX', 'Spain', 'EUR', '€ #,##0.00'),
  ('apple.com/es', 'xx.AppleXX', 'Spain', 'EUR', '€ #,##0.00'),
  ('electroking.es', 'es.ElectroKingES', 'Spain', 'EUR', '€ #,##0.00'),
  ('euronics.es', 'es.EuronicsES', 'Spain', 'EUR', '€ #,##0.00'),
  ('101gigas.com', 'es.Gigas101ES', 'Spain', 'EUR', '€ #,##0.00'),
  ('lidl.es', 'xx.LidlXX', 'Spain', 'EUR', '€ #,##0.00'),
  ('ulabox.com', 'es.UlaBoxES', 'Spain', 'EUR', '€ #,##0.00'),
  ('zalando.es', 'xx.ZalandoXX', 'Spain', 'EUR', '€ #,##0.00'),

  ('amazon.com.tr', 'xx.AmazonXX', 'Turkey', 'TRY', '#,##0.00 TL'),
  ('apple.com/tr', 'xx.AppleXX', 'Turkey', 'TRY', '#,##0.00 TL'),
  ('gittigidiyor.com', 'tr.GittiGidiyorTR', 'Turkey', 'TRY', '#,##0.00 TL'),
  ('hepsiburada.com', 'tr.HepsiBuradaTR', 'Turkey', 'TRY', '#,##0.00 TL'),
  ('mediamarkt.com.tr', 'xx.MediaMarktXX_2', 'Turkey', 'TRY', '#,##0.00 TL'),
  ('n11.com', 'tr.N11TR', 'Turkey', 'TRY', '#,##0.00 TL'),
  ('teknosa.com', 'tr.TeknosaTR', 'Turkey', 'TRY', '#,##0.00 TL'),
