...
public class CompanyTransMapper implements RowMapper<CompanyTrans> {

  @Override
  public CompanyTrans map(ResultSet rs, StatementContext ctx) throws SQLException {
    CompanyTrans m = new CompanyTrans();
