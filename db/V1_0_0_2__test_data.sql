...
insert into country (code, name, locale, lang, flag) values ('us', 'United States', 'en_US', 'English', 'us.png');
...
insert into site (name, domain, url, logo, logo_mini, currency_code, currency_symbol, thousand_separator, decimal_separator, country_id, class_name)
values ('Amazon DE', 'amazon.de', 'https://www.amazon.de', null, null, 'EUR', '€',',','.', 2, 'xx.Amazon');

insert into site (name, domain, url, logo, logo_mini, currency_code, currency_symbol, thousand_separator, decimal_separator, country_id, class_name)
values ('Ebay DE', 'ebay.de', 'https://www.ebay.de', null, null, 'EUR', '€',',','.', 2, 'xx.Ebay');
