...
values ('Amazon UK', 'amazon.co.uk', 'https://www.amazon.co.uk', null, null, 'GBP', '£',',','.', 1, 'io.inprice.scrapper.manager.websites.xx.Amazon');

insert into site (name, domain, url, logo, logo_mini, currency_code, currency_symbol, thousand_separator, decimal_separator, country_id, class_name)
values ('Ebay UK', 'ebay.co.uk', 'https://www.ebay.co.uk', null, null, 'GBP', '£',',','.', 1, 'io.inprice.scrapper.manager.websites.xx.Ebay');

insert into site (name, domain, url, logo, logo_mini, currency_code, currency_symbol, thousand_separator, decimal_separator, country_id, class_name)
values ('Argos UK', 'argos.co.uk', 'https://www.argos.co.uk', 'https://www.argos.co.uk/homepage-assets/static/img/favicon.ico',
        'https://www.argos.co.uk/homepage-assets/static/img/favicon.ico', 'GBP', '£',',','.', 1, 'io.inprice.scrapper.manager.websites.uk.Argos');

insert into site (name, domain, url, logo, logo_mini, currency_code, currency_symbol, thousand_separator, decimal_separator, country_id, class_name)
values ('Amazon Germany', 'amazon.de', 'https://www.amazon.de', null, null, 'EUR', '€',',','.', 2, 'io.inprice.scrapper.manager.websites.xx.Amazon');

insert into site (name, domain, url, logo, logo_mini, currency_code, currency_symbol, thousand_separator, decimal_separator, country_id, class_name)
values ('Ebay Germany', 'ebay.de', 'https://www.ebay.de', null, null, 'EUR', '€',',','.', 2, 'io.inprice.scrapper.manager.websites.xx.Ebay');
...
values ('Gittigidiyor Türkiye', 'gittigidiyor.com', 'https://www.gittigidiyor.com', 'https://www.gittigidiyor.com/fred/framework/assets/img/core/apple-touch-icons/apple-icon-76x76-precomposed.png',
        'https://www.gittigidiyor.com/fred/framework/assets/img/core/apple-touch-icons/apple-icon-precomposed.png', 'TRY', 'TL',',','.', 3, 'io.inprice.scrapper.manager.websites.tr.GittiGidiyor');
...
values ('Hepsiburada Türkiye', 'hepsiburada.com', 'https://www.hepsiburada.com', 'https://images.hepsiburada.net/assets/sfstatic/Content/images/Icon.png',
        'https://images.hepsiburada.net/assets/sfstatic/Content/images/favicon.ico', 'TRY', 'TL',',','.', 3, 'io.inprice.scrapper.manager.websites.tr.HepsiBurada');
