...
insert into user (company_name, contact_name, email, password_hash, password_salt) values ('inprice', 'mustafa', 'aaa@bb.com', 'ab', 'cd');
insert into user_brand (name, user_id) values ('limon', 1);
insert into user_plan (name, user_id, brand_id, plan_id, due_date) values ('limon için alan', 1, 1, 1, '2020-04-12 10:10:10');

insert into product (code, name, brand, price, user_plan_id) values ('455930318', 'SAMSUNG GALAXY A10 32 GB 2 GB RAM ÇİFT HATLI', 'Samsung', 1000, 1);

insert into link (url, product_id, user_plan_id)
values
